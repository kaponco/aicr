...
| **Criteria** | Query parameters that define the target environment: `service` (eks/gke/aks/oke/ocp/kind/lke/any), `accelerator` (h100/gb200/b200/a100/l40/rtx-pro-6000/any), `intent` (training/inference/any), `os` (ubuntu/rhel/cos/amazonlinux/talos/any), `platform` (kubeflow/dynamo/nim/any), and `nodes`. |
